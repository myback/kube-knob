...
options:
  ...
  set_labels:
    ...
    default: null
    description:
      - The flag for labeling specific resources.
  labels:
    required: false
    default: null
    description:
...
class KubeManager(object):
    ...
    def delete(self):
        ...
        if self.filename:
            ...
            if self.labels:
                cmd.append('--selector=' + self.labels)
    ...
    def set_label(self, overwrite=False):
        cmd = ['label']
        ...
        if isinstance(self.labels, str):
            cmd.append(self.labels)
        else:
            cmd.extend(self.labels)
...
def main():
    ...
    if state == 'present':
        if module.params.get('set_labels'):
            result = manager.set_label()
        else:
        ...
        if module.params.get('set_labels'):
            result = manager.set_label(overwrite=True)
        else:
